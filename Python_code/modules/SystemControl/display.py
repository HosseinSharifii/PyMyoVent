...
def display_baro_results (data_structure, output_file_string="",dpi=300):
    ...
    if(hasattr(data_structure,'P_tilda')):
        ...
        ax3.set_ylabel('P_tilda (mmHg)', fontsize = 10)
    ...
    ax3.set_ylabel('Heart period,$T (s)$', fontsize = 10)
    ...
    #ax6.set_xlabel('time (s)', fontsize = 15)
    ax7.set_ylabel('$V_{max,up}$ multiplier\n factor', fontsize = 10)
