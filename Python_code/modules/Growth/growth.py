...
class growth():
    ...
    def __init__(self,growth_params,initial_numbers_of_hs,hs_module,circ_params,data_buffer_size):
        ...
        self.ventricle_wall_volume = float(circ_params["ventricle"]["wall_volume"][0])
        #float(self.growth["ventricle_wall_volume"][0])

        # wall_thickness
        self.ventricle_slack_volume = float(circ_params["ventricle"]["slack_volume"][0])
        #float(self.growth["ventricle_slack_volume"][0])
